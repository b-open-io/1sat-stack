...
| [1sat-engine: Redis Protocol Migration](./engine-migration.md) | **In Progress** | Replace Store interface with Redis protocol (redcon + Badger). Foundation for distributed compute. Branch: `engine` |
