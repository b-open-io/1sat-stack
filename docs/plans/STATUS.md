...
| [External Arcade Migration](./external-arcade-migration.md) | **Not Started** | Migrate from embedded-sync arcade to external HTTP arcade with SSE; refactor paymail and indexer event listener |
